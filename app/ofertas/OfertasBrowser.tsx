...
export default function OfertasBrowser({
  ...
  const inputCls =
    "w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 outline-none transition-shadow focus:border-gray-900 focus:shadow-sm";
                ...
                <article className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition-all hover:-translate-y-0.5 hover:border-gray-300 hover:shadow-md">
                  ...
                  <div className="mt-4 flex items-center justify-between gap-3">
                    ...
                    <Link
                      ...
                      className="rounded-xl border border-gray-900 px-4 py-2 text-sm font-medium text-gray-900 transition-colors hover:bg-gray-900 hover:text-white"
                    >
                      Ver oferta
                    </Link>
                  </div>
